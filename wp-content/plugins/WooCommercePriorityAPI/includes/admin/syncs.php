        ...
        <table class="p18a" style="max-width: 300px;"  cellspacing="20">
            ...
            <tr>
                ...
                <td>
                    ...
                    ><?php echo  stripslashes($this->option('sync_items_priority_config'))?></textarea >
                </td>
                <td>{
                    "days_back":"13",
            ...
            <tr>
                ...
                <td>
                    <textarea  style="width:300px" name="extra_data_sync_pricelist_priority" form="p18aw-sync" ><?php echo(stripslashes($this->option('extra_data_sync_pricelist_priority'))); ?></textarea>
                </td>
            </tr>
