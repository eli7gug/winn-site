		...
		<div class="wdp-row wdp-filter-item" data-index="{f}">
			...
			<div class="wdp-column wdp-condition-field-gift-mode" style="max-width: 200px">
				<select name="rule[get_products][value][{f}][gift_mode]">
					<option value="giftable_products"><?php _e("Give gift from list", 'advanced-dynamic-pricing-for-woocommerce') ?></option>
					<option value="use_product_from_filter"><?php _e("Use product from filter", 'advanced-dynamic-pricing-for-woocommerce') ?></option>
				</select>
			</div>
