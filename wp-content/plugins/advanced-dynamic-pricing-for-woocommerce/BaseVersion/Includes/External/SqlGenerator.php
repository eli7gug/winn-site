...
class SqlGenerator {
	 ...
	 * @return bool
	 */
	public function apply_rule_to_query( $context, $rule ) {
		...
		if ( $context->get_option( 'allow_to_exclude_products' ) && $filter->getExcludeProductIds() ) {
			$ids = "( '" . implode( "','", array_map( 'esc_sql', $filter->getExcludeProductIds() ) ) . "' )";
	...
	public function get_exclude_where() {
