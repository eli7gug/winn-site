...
class ProcessedProductSimple {
	...
	public function getCalculatedPrice( $pos = null ) {
		...
		return $this->overrideCentsStrategy->maybeOverrideCents( $item->getPrice(), $item );
	}
	...
	public function getPrice( $pos = null ) {
		...
		return ! $this->compareStrategy->floatsAreEqual( $totalAdjustments, 0 ) ? $this->overrideCentsStrategy->maybeOverrideCents( $item->getPrice() , $item ) : $item->getOriginalPrice();
	}
