...
class ProductStockController {
	 ...
	 */
	public function add( $productId, $qty, $parentId = 0, $variationAttributes = array(), $cartItemData = array()) {
	 ...
	 * @return float
	 */
	public function get( $productId, $parentId = 0, $variationAttributes = array(), $cartItemData = array() ) {
	 ...
	 * @return float
	 */
	public function getQtyAvailableForSale( $productId, $qtyRequired, $parentId = 0, $variationAttributes = array(), $cartItemData = array() ) {
		...
		if ( $product->managing_stock() ) {
			if ( $product->backorders_allowed() ) {
				...
				$availableForNow = $product->get_stock_quantity() - $this->get( $productId, $parentId, $variationAttributes, $cartItemData );
