		...
		$optionsList->register(
			...
			$builder::selective(
				...
				array(
					...
					"disable_if_any_rule_applied"          => __( "Disable all if any rule applied", 'advanced-dynamic-pricing-for-woocommerce' ),
					"disable_if_any_of_cart_items_updated" => __( "Disable all if any of cart items updated", 'advanced-dynamic-pricing-for-woocommerce' ),
				),
				"apply"
			),
